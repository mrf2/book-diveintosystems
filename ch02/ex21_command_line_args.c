...
int main(int argc, char **argv)
{
	...
	// (1) check that the user passed the correct number of command line
	// args
	if (argc != 5) {
	...
	// (2) get command line argument's vlues, sometimes converting them
	//	from startings to other types
